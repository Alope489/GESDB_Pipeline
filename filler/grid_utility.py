"""Fill Grid & Utility group from web search."""
import logging
...
def fill_group(
    ...
    query = f"{loc} grid interconnection ISO RTO system operator utility " + " ".join(descriptions.values())
